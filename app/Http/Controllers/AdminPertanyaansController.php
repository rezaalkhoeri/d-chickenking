<?php namespace App\Http\Controllers;
	...
	class AdminPertanyaansController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Pesan','name'=>'pesan','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
