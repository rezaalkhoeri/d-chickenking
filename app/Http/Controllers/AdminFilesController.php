<?php namespace App\Http\Controllers;
	...
	class AdminFilesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"File","name"=>"file","image"=>true];
			...
			$this->form = [];
			$this->form[] = ['label'=>'File','name'=>'file','type'=>'upload','validation'=>'image','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'File','name'=>'file','type'=>'textarea','validation'=>'required|string|min:5|max:5000|image|image|image','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Jenis','name'=>'jenis','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
