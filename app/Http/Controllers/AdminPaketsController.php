<?php namespace App\Http\Controllers;
	...
	class AdminPaketsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'File','name'=>'file','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
